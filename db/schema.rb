...
ActiveRecord::Schema[7.0].define(version: 2024_02_08_073643) do
  ...
  create_table "merchandises", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.integer "shipping_load_id", null: false
    t.integer "prefecture_id", null: false
  ...
  create_table "users", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.string "name_secound", default: "", null: false
    t.string "name_first_kana", default: "", null: false
    t.string "name_secound_kana", default: "", null: false
